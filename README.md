...
<p align="center">
  <img src="images/lemon_pick_up.gif" alt="lemon_pick_up" height="400vh"/>
</p>
...
In addition, the codebook vectors that are predicted by the code predictor head for each quantization layer based on the sequence of observations are combined and decoded to action with the RVQ Decoder that was trained in Stage 1.
